				   ...
				   <div class="contenedor_panel">	
						...
						<div class="panel">
							<div class="panel_header">
								<h2>
									<span>
									<?php
										echo $header_tabla_mas_populares;
							...
							<?php
							if (isset($resultados_mas_populares)){
								if(count($resultados_mas_populares) > 0){
									$contador = 0;
							...
							?>
											...
											<li>
													<a href="<?php echo site_url('browser/ver_album/' . $row['id_album'] ) ?>" title="<?php echo $row['nombre_album']; ?>">
													<img src="<?php echo site_url('imagenes/viewAlbum/' . $row['id_album']); ?>"/>
													</a>
												<!--a href="#"><img src=""></a-->
									
													
												<span class="item_panel_home">
												
												<!--Nombre cancion -->
												<b><a  class="nombre_album_panel_home" href="<?php echo site_url('browser/ver_album/' . $row['id_album'] ) ?>" ><?php echo $row['nombre_album']; ?></a></b>
													
												</span>
												<a class="link" href="<?php echo site_url('browser/ver_profile_artista/' . $row['id_artista'] ) ?>" ><?php echo $row['nombre_artista']; ?></a>
											</li>
					...
					<div class="contenedor_panel">	
						...
						<div class="panel">
							...
							<?php
							if (isset($resultados_mas_nuevos)){
								if(count($resultados_mas_nuevos) > 0){
									$contador = 0;
							...
							?>
											...
											<li>
													<a href="<?php echo site_url('browser/ver_album/' . $row['id_album'] ) ?>" title="<?php echo $row['nombre_album']; ?>">
													<img src="<?=site_url('imagenes/viewAlbum/' . $row['id_album'])?>">
													</a>
												<!--a href="#"><img src=""></a-->
