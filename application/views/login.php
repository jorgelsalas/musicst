			   ...
			   <div id="contenedor_contenido">			
				...
				?>
						...
						<p class="campo_form_registro">
							...
							<br/>
							<input type="text" name="nombre_artista" id = "input_usuario" 
							/>
							<br/>
						...
						<p>
							<input id="boton_submit_form_nuevo_usuario" type="submit" value="Enviar" onclick="enviarLogin('input_usuario','campo_usuario_login', 'input_password', 'campo_password_login');" />
						</p>
